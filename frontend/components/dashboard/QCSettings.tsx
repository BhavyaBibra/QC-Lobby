...
interface QCSettingsProps {
  ...
  onQcModeChange: (mode: 'polisher' | 'guardian') => void;
}

export default function QCSettings({ qcMode, onQcModeChange }: QCSettingsProps) {
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 gap-3">
          {/* Polisher Card */}
          <button
            onClick={() => onQcModeChange('polisher')}
          ...
          {/* Guardian Card */}
          <button
            onClick={() => onQcModeChange('guardian')}
            className={`relative p-4 rounded-xl border-2 transition-all ${
              qcMode === 'guardian'
